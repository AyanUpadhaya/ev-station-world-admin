...
const ServiceAddForm = () => {
  ...
  <div className='w-full'>
    <BackToPrev path="/services" title={`Back`}></BackToPrev>
    ...
    <div className="bg-white p-6 rounded-2xl h-full overflow-y-scroll relative no-scrollbar">
      <div className="">
        ...
        {imagePreview && (
          ...
          {type === 'edit' ?<button
            type="submit"
            className={`mx-auto my-5 w-52 h-14 bg-primary py-[20px] px-4 rounded-lg text-white capitalize flex justify-center items-center`}
          >
            Update Service
          </button> :
          <button
