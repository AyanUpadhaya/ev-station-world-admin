    ...
    <section className="h-full relative overflow-auto p-6 ">
      <div className="flex flex-col gap-8">
        ...
        <div className="w-full bg-white p-6 rounded-2xl">
          {/* title  */}
          <div>
            <h4 className="text-[20px] text-blackMediumEmp font-bold font-poppins">Dashboard</h4>
            <p className="mt-2 text-base font-normal font-poppins">All the overview is here</p>
