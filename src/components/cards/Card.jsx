...
function Card({ data }) {
  const { background, svgBg, number, title, svg,borderColor,type } = data || {};
  return (
    <div className={`p-6 ${background} border ${borderColor} rounded-2xl`} >
      <div
      ...
      <div className="mt-6">
        <p className="text-2xl font-semibold text-blackMediumEmp font-poppins">
          {type == "numbers"?"$":''}{number}{type == "users"?"K":''}
        </p>
