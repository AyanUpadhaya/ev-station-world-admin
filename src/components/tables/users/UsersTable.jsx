...
function UserTable({ data,setIsAscending }) {
  ...
  return (
    ...
    <div className="h-full flex flex-col justify-between">
            ...
            <tbody className="">
              {currentRows?.map((user, i) => (
                ...
                />
                  ...
                  {user?.fullName?.length>16?user?.fullName.slice(0,16)+"...":user?.fullName}
                  </td>
                  <td className="py-3 text-blackLowEmp text-base font-normal font-poppins">{user?.email}</td>
                  <td className="py-3 text-blackLowEmp text-base font-normal font-poppins">{user?.phone}</td>
                  ...
                  {/* <td className="py-3 text-blackLowEmp text-base font-normal font-poppins flex items-center justify-center gap-4">
      ...
      <div className="w-full">
        ...
        ></Pagination>
      <ConfirmationModal title={'User'} handleStatus={handleDelete} ></ConfirmationModal>
