...
// import { deleteUserById, getAllUsers } from "../../../features/users/usersSlice";
function NewsTable({ data,setIsAscending }) {
      ...
      <div className=" overflow-x-auto">
        <table className="table w-full table-pin-rows table-pin-cols">
          ...
          {currentRows?.length === 0 ? (
            ...
            <tbody className="">
              {currentRows?.map((news, i) => (
                <tr className=" bg-white text-blackSemi" key={news._id}>
                  <td className="py-3">
                ...
                />
                  ...
                  <td className="py-3 text-blackLowEmp text-base font-normal font-poppins">
                    {news?.title.length>15?news?.title.slice(0,15)+"...":news?.title}
                   </td>
                  <td className="py-3 text-blackLowEmp text-base font-normal font-poppins">
                  {news?.description.length>20?news?.description.slice(0,20)+"...":news?.description}</td>
                  <td className="py-3 text-blackLowEmp text-base font-normal font-poppins">
                  ...
                  <button type="button" onClick={() => handleNavigate(news)}>
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
