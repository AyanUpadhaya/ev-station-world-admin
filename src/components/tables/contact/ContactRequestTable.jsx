...
function ContactRequestTable({ data,setIsAscending }) {
  ...
  return (
    ...
    <div className="h-full flex flex-col justify-between">
      <div className=" overflow-x-auto">
        <table className="table w-full table-pin-rows table-pin-cols">
          ...
          {currentRows?.length === 0 ? (
            ...
            <tbody className="">
              {currentRows?.map((contact, i) => (
                <tr className=" bg-white text-blackSemi" key={contact._id}>
                  <td className="py-3">
                  ...
                  <td className="py-3 text-blackLowEmp text-base font-normal font-poppins">
                  {new Date(contact?.timestamp*1000).toLocaleDateString({
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric'
                  })}
      ...
      <div className="w-full">
        ...
        ></Pagination>
      <ContactModals contactData={selectedItem}></ContactModals>
      <ConfirmationModal title={'Contact'} handleStatus={handleDelete} ></ConfirmationModal>
