...
import ReviewsModals from "../../modals/ReviewsModals";


function ReviewsTable({ data,setIsAscending }) {
  ...
  return (
    ...
    <div className="h-full flex flex-col justify-between">
        ...
        <table className="table w-full table-pin-rows table-pin-cols">
          <thead className=" p-0">
            <tr className="font-bold  text-3xl text-blackHigh">
              ...
              <th className="bg-tablenav text-base text-blackMediumEmp font-poppins font-semibold py-5">Description</th>
              <th className="bg-tablenav text-base text-blackMediumEmp font-poppins font-semibold py-5">Ratings</th>
            ...
            <tbody className="">
              {currentRows?.map((review, i) => (
                ...
                />
                  ...
                  {review?.name.length>16?review?.name.slice(0,16)+"...":review?.name}
                  </td>
                  <td className="py-3 text-blackLowEmp text-base font-normal font-poppins">
                  {review?.description.length>20?review?.description.slice(0,20)+"...":review?.description}

                  </td>
                  <td className="py-3 text-blackLowEmp text-base font-normal font-poppins">{review?.rating}</td>
                  <td className="py-3 text-blackLowEmp text-base font-normal font-poppins">
      ...
      <ReviewsModals reviewData={selectedItem}></ReviewsModals>
      <ConfirmationModal title={'Review'} handleStatus={handleDelete} ></ConfirmationModal>
